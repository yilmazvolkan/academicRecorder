    ...
    <body style="background-color: Moccasin   ; color: Indigo  ; margin: 40 ">
        ...
        <?php
            ...
            if ($conn->connect_error) {
                ...
                if($row["isAdmin"] == 1){
                    // Insert the record
                    $sql = "INSERT INTO AuthorPaper(Author_ID, Paper_ID) " .
                        "VALUES('" . $_POST['Aut_ID'] . "', '" . $_POST['Pap_ID'] . "')";

                    if ($conn->query($sql) === TRUE) {
                        echo "Author added successfully! <br />";
                    } else {
                        echo "Error updating author record. Author has already been added:  " . $conn->error;
                    }
                    echo "<br>Click <a href = 'dashboard.php'> here</a> to return to dashboard. <br />";
                    echo "<br>Click <a href = 'add_more_author.php'> here</a> to add more Authors to the Paper. <br />";
                }
                else{
                    ?>
                    <br>
