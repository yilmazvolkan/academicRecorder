    ...
    <body style="background-color: Moccasin   ; color: Indigo  ; margin: 40 ">
        ...
        <?php
            ...
            if ($conn->connect_error) {
                ...
                if($row["isAdmin"] == 1){
        ?>
                    <form action="create_author_result.php" method="post">
                        <p>Author Name: <input type="text" name="authorName" value = "" /></p>
                        <p>Author Surname: <input type="text" name="authorSurname" value = "" /></p>
                        <p><input type="Submit" value = "Create Author Record"/></p>
                    </form>
