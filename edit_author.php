            ...
            if ($conn->connect_error) {
                ...
                if($row["isAdmin"] == 1){
                    ...
                    if ($result->num_rows > 0) {
                        ?>
                        <form action="edit_author_result.php" method="post">
                        ...
                        ?>
                            ...
                            <p>Author Name: <input type="text" name="authorName" value = "<?php echo $row["authorName"] ?>" /></p>
                            <p>Author Surname: <input type="text" name="authorSurname" value = "<?php echo $row["authorSurname"] ?>" /></p>
